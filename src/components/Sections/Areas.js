...
<<<<<<< HEAD
            ...
            <Card titulo="¡Muchas áreas mas!" urlImg="https://static.vecteezy.com/system/resources/previews/003/335/579/non_2x/desktop-source-code-and-wallpaper-by-coding-and-programming-free-photo.jpg" descripcion='Tambien abarcamos areas de desarrollo de sitios web, aplicaciones, frontend, backend, entre muchas mas temas como tambien en parasigmas de programación' transicion="fade-up"/>
=======
            <Card titulo="Lógica de Programación" urlImg="https://www.placeimg.com/300/300/animals" descripcion="Temas escenciales al momentos de programar, conceptos básicos y complejos" transicion="fade-up"/>
            <Card titulo="Proyectos Universitarios" urlImg="https://www.placeimg.com/300/300/people" descripcion="¿No tienes quién te explique? Te explicamos temas que hayas visto en clase y no te hayan quedado muy claro. ¡Tambien te ayudamos a impulsar tu proyectos académicos!" transicion="fade-up"/>
            <Card titulo="Proyectos personales" urlImg="https://www.placeimg.com/300/300/nature" descripcion="¿Estropeaste un proyecto? ¿No sabes como integrar una funcionalidad en tu código? Nosotros te ayudamos a resolver esos grander errores en tu programa y a aplicar nuevas tecnicas de programación" transicion="fade-up"/>
            <Card titulo="¡Muchas áreas mas!" urlImg="https://www.placeimg.com/300/300/tech" descripcion='Tambien abarcamos areas de desarrollo de sitios web, aplicaciones, frontend, backend, entre muchas mas temas como tambien en parasigmas de programación' transicion="fade-up"/>
>>>>>>> parent of 2fefaca (images cards added)
        </Tarjetas>
        <BtnAgendar/>
    </section>
  )
